...
test_that("getwd() match folders when testing or checking", {
    ...
    if (!is_checking_package()) {
        ...
        expect_true(result == "C:/Users/msfz751/Documents/rNodal.Rcheck/tests/testthat" ||
                        result == "I:/src/rNodal.Rcheck/tests/testthat")
    }
})
...
test_that("there is a HDF5 file under extdata", {
    result <- nodal_status()
    if (!is_checking_package()) {
        expect_true(result == "C:/Users/msfz751/Documents/rNodal/inst/extdata/default.hdf5" ||
                        result == "I:/src/rNodal/inst/extdata/default.hdf5")
    } else {
