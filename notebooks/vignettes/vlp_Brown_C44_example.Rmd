...
pointed at finding the bottomhole flowing pressure (BHFP) given the surface conditions and the wellhead pressure but rather calculating the length of the tubing if BHP is known, the calculations here demonstrate that both can be calculated or verified using this algorithm.
...
input_example <- setWellInput(
                              ...
                              dev_survey = dev_survey_txt
                              )

well_model <- setVLPmodel(vlp.model = "hagbr.mod", 
                          segments = 15, 
                          tol = 0.00001,
                          well_input = input_example
                          )
